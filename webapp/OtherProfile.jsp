...
<body>
 <div id="mainbody">
   ...
   <!-- 프로필 페이지 컨테이너 시작 -->
      ...
      <div class="profile-header">
         <div class="profile-photo-section">
            <!-- 24-09-13 오전 프로필사진로드-->
            <label for="user_img" class="custom-file-upload"> 
            <img src="./file/<%=profileImg.getUser_img()%>" 
               id="profileImage">
            </label>
         </div>
         <div class="user-info">
            <h2 class="username"><%=user.getUser_nick()%></h2>
            <br>
         </div>
      </div>
   ...
   <!-- 획득한 뱃지 섹션 -->
   <% List<BadgeDTO> badges = new BadgeDAO().loadingBadge(dto);%>
   ...
   <div class="posts-section">
      ...
      <%
		List<BoardDTO> boards = new BoardDAO().userBoard(dto);
